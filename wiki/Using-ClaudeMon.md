...
| **STALE** banner | No push from the Mac for 10+ minutes | Mac asleep / agent stopped / cable out — see [troubleshooting](https://github.com/awizemann/ClaudeMon32/blob/main/docs/troubleshooting.md#stale-banner) |
